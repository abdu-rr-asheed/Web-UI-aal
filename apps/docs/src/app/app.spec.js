 ...
 *
 * The docs app is an audit target — Lighthouse and Playwright run against it
...
describe('App shell', () => {
    ...
    describe('AR-24 — landmark and heading structure', () => {
        ...
        it('does not skip heading levels', async () => {
            const levels = [...(await render()).querySelectorAll('h1,h2,h3,h4,h5,h6')].map((h) => Number(h.tagName[1]));
